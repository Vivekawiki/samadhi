          ...
          <Tabs defaultValue="courses" className="space-y-4">
            ...
            <TabsContent value="courses" className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {courses.map(course => (
                  <Card key={course.id} className="overflow-hidden border border-indian-saffron bg-gradient-to-br from-indian-cream to-white">
                ...
                <Card className="border-dashed border-2 border-indian-saffron flex flex-col items-center justify-center p-6 bg-gradient-to-br from-indian-cream to-white">
