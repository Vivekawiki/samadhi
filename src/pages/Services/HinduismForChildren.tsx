...
const HinduismForChildren = () => {
  return (
    <div className="prose prose-lg max-w-none animate-fade-in">
      ...
      <div className="bg-gradient-to-r from-spiritual-50 to-spiritual-100 p-8 rounded-2xl mb-10 shadow-sm border-2 border-spiritual-200">
      ...
      <div className="my-8 p-6 bg-yellow-50 rounded-2xl border-2 border-yellow-100 shadow-sm">
        ...
        <ul className="space-y-4">
          {[
            { text: "Age-appropriate lessons on Hindu philosophy, mythology, and values", icon: <BookOpen className="w-5 h-5 text-spiritual-500" /> },
            { text: "Interactive activities, storytelling, and creative projects", icon: <Sun className="w-5 h-5 text-spiritual-500" /> },
            { text: "Simple meditation and yoga practices suitable for children", icon: <Heart className="w-5 h-5 text-spiritual-500" /> },
            { text: "Special celebrations of Hindu festivals", icon: <Star className="w-5 h-5 text-spiritual-500" /> },
            { text: "Learning of simple bhajans (devotional songs) and mantras", icon: <BookOpen className="w-5 h-5 text-spiritual-500" /> },
          ].map((item, index) => (
      ...
      <div className="my-10 p-6 bg-purple-50 rounded-2xl border-2 border-purple-100 text-center">
      ...
      <div className="mt-8 text-center">
        <p className="text-2xl mb-4 font-heading text-spiritual-600">
          Access our fun learning resources!
        </p>
        <Button href="/learn" size="lg" className="rounded-full px-8 py-6 text-lg">
