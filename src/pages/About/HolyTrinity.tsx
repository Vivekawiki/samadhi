          ...
          <TabsContent value="sri-ramakrishna" className="animate-fade-in">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="md:col-span-2">
                ...
                <ul>
                  <li>The harmony of all religions - different spiritual paths lead to the same ultimate goal</li>
                  <li>God can be realized through sincere spiritual practice</li>
                  <li>The Divine exists in all beings</li>
                  <li>Renunciation of worldly attachments for spiritual advancement</li>
                  <li>The importance of devotion and love in spiritual life</li>
                </ul>
                ...
                <div className="bg-gray-50 p-6 rounded-lg my-6 border-l-4 border-spiritual-500">
          ...
          <TabsContent value="sri-sarada-devi" className="animate-fade-in">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="md:col-span-2">
                ...
                <h4 className="text-xl font-heading font-medium mt-6 mb-3">Key Teachings</h4>
                <ul>
                  <li>Universal motherhood - seeing and serving all as one's own children</li>
                  <li>The importance of spiritual practice in daily life</li>
                  <li>Patience and perseverance on the spiritual path</li>
                  <li>The power of selfless love and service</li>
                  <li>The dignity and spiritual equality of women</li>
                </ul>
          ...
          <TabsContent value="swami-vivekananda" className="animate-fade-in">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="md:col-span-2">
                ...
                <h4 className="text-xl font-heading font-medium mt-6 mb-3">Key Teachings</h4>
                <ul>
                  <li>Practical Vedanta - applying spiritual principles to daily life</li>
                  <li>Service to humanity as worship of the Divine</li>
                  <li>The strength and self-reliance of the individual soul</li>
                  <li>The harmony of religion and science</li>
                  <li>The importance of character building and education</li>
                  <li>The revival of India through spiritual awakening and social reform</li>
                </ul>
