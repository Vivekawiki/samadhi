...
const events = [
  ...
  },
  {
    ...
    description: 'The Sub-Centre will host a seminar on Sri Ramakrishna\'s Organisational Wisdom and the Early History of the Ramakrishna Movement in South Africa (1897-1965)',
